...
public class LoginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtsenha.setBounds(20, 250, 330, 30);
        ...
        jLabel12.setText("Se registre aqui!");
        ...
        jLabel12.setBounds(250, 450, 100, 16);

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel13.setText("Você ainda não tem uma conta?");
        jPanel2.add(jLabel13);
        jLabel13.setBounds(60, 450, 190, 16);

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 440, 550));

        setSize(new java.awt.Dimension(856, 552));
    ...
    // Crie um HikariDataSource com as configurações necessárias
    ...
    // Passe o dataSource para o construtor do LoginController
    LoginController controller = new LoginController(dataSource);
    
    boolean sucesso = controller.fazerLogin(username, password);
    if (sucesso) {
        // Fechar a tela de login
        dispose();
        JOptionPane.showMessageDialog(null, "Parabéns, você conseguiu entrar!");
        // Abrir a tela de AdministradorView
